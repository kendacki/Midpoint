  ...
  return (
    <header className="glass-panel reveal-up sticky top-3 z-30 mx-auto mb-6 w-full max-w-6xl rounded-2xl px-3 py-3 sm:px-4">
      <div className="flex flex-col gap-4 sm:gap-5">
        ...
        <div className="flex flex-wrap items-center justify-start gap-2 text-sm font-medium text-zinc-700 sm:gap-3">
          <Link className="rounded-lg border border-white/60 bg-white/45 px-3 py-1.5 whitespace-nowrap touch-manipulation transition-transform duration-75 hover:scale-[1.03] hover:bg-white/65 hover:text-zinc-950 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2" href="/">Home</Link>
